...
describe('<DateInput2 />', () => {
  ...
  describe('callback props', () => {
    ...
    it('should\'t call onFocus prop if one of format inputs has been focused', () => {
      ...
      let wrapperElement = wrapper.get(0);
      let firstFormatPartInput = wrapper.find('.opuscapita_date-input__format-part-input').get(0);
      let secondFormatPartInput = wrapper.find('.opuscapita_date-input__format-part-input').get(1);
      let thirdFormatPartInput = wrapper.find('.opuscapita_date-input__format-part-input').get(2);

      firstFormatPartInput.focus();
      secondFormatPartInput.focus();
      thirdFormatPartInput.focus();
